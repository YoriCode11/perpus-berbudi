            ...
            <div class="card shadow-lg border-0 rounded-lg mt-5">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('register') ?>" method="post">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" id="inputEmail" name="email" type="email" placeholder="name@example.com" value="<?= old('email') ?>" required />
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3 mb-md-0">
                                    <input class="form-control" id="inputPasswordConfirm" name="pass_confirm" type="password" placeholder="Confirm password" required />
